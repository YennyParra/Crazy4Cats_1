...
ActiveRecord::Schema[7.0].define(version: 2023_08_21_204231) do
  ...
  create_table "cat_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["article_id"], name: "index_cat_comments_on_article_id"
    t.index ["catuser_id"], name: "index_cat_comments_on_catuser_id"
  end
  ...
  create_table "reactions", force: :cascade do |t|
    ...
    t.bigint "cat_comment_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["article_id"], name: "index_reactions_on_article_id"
    t.index ["cat_comment_id"], name: "index_reactions_on_cat_comment_id"
    t.index ["catuser_id"], name: "index_reactions_on_catuser_id"
  end

  add_foreign_key "articles", "aventures"
  add_foreign_key "cat_comments", "articles"
  add_foreign_key "cat_comments", "catusers"
  add_foreign_key "reactions", "articles"
  add_foreign_key "reactions", "cat_comments"
